...
describe('s2', function () {
  it("should cellid eq", function () {
    var s2LatLng = new s2.S2LatLng(new s2.S2Cell(new s2.S2CellId('3763522032298623000')).getCenter());
    var s = s2LatLng.normalized();
    assert('28.722253,115.848641' === s2LatLng.toString());
  });
