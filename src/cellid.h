...
protected:
    ...
    static void GetEdgeNeighbors(const v8::FunctionCallbackInfo<v8::Value>& args);
    static void GetVertexNeighbors(const v8::FunctionCallbackInfo<v8::Value>& args);
    static void GetAllNeighbors(const v8::FunctionCallbackInfo<v8::Value>& args);
