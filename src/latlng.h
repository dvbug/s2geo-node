...
class LatLng : public node::ObjectWrap {
 ...
 private:
  ...
  static void LatRadians(v8::Local<v8::String> property, const v8::PropertyCallbackInfo<v8::Value>& args);
  static void LngRadians(v8::Local<v8::String> property, const v8::PropertyCallbackInfo<v8::Value>& args);
